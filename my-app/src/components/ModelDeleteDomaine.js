...
function ModelDeleteDomaine(props) {
  ...
  return (
    ...
    <>
    <button type="button" onClick={handleShow} className="btn btn-icon btn-sm js-sweetalert" title="Delete" data-type="confirm"  ><i className="fa fa-trash-o text-danger"></i></button>
