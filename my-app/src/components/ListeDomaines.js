...
class ListDomaineComponent extends Component {
    constructor(props) {
        ...
        this.addDomaine = this.addDomaine.bind(this);
    ...
    addDomaine(){
        this.props.history.push('/add-domaine');
    }
                ...
                <div className="tab-pane active" id="gestion-domaine">
                  ...
                  <div class="card-body">
                          <div class="row">
                              ...
                              <div class="col-lg-2 col-md-4 col-sm-4">
                              <button type="button" class="btn btn-primary" onClick={ () => this.addDomaine()}><i class="fa fa-plus mr-2"></i>Domaine</button>
